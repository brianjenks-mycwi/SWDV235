...
*   12/5/2018      BRIAN JENKS     Removed Borrower ID from table
*************************
--%>
<asp:Content runat="server" ContentPlaceHolderID="mainContent">
    ...
    <section>
        ...
        <asp:GridView ID="GridView1" runat="server" AllowPaging="True"
            AutoGenerateColumns="False" DataKeyNames="BorrowerID" DataSourceID="SqlDataSource1"
            ...
            <Columns>
                <asp:BoundField DataField="BorrowerID" HeaderText="BorrowerID" InsertVisible="False" ReadOnly="True" SortExpression="BorrowerID" Visible="False" />
