...
*   12/5/2018      BRIAN JENKS     Removed Disk ID information, made information more accessible
*************************
--%>
<asp:Content runat="server" ContentPlaceHolderID="mainContent">
    ...
    <section>
        ...
        <asp:DetailsView ID="dvInsertInventory" runat="server" AutoGenerateRows="False"
            CssClass="table table-bordered table-condensed" DataSourceID="SqlDataSource2" DefaultMode="Insert"
            OnItemInserted="dvInsertInventory_ItemInserted" HeaderText="Create a disk here">
            <Fields>
    ...
    <section>
        ...
        <%-- Allows a user to edit/delete disks --%>
        <asp:GridView ID="GridView1" runat="server" AllowPaging="True"
            AutoGenerateColumns="False" DataKeyNames="ItemID" DataSourceID="SqlDataSource1"
            OnPageIndexChanged="GridView1_Changed" OnRowEditing="GridView1_Changed" OnRowDeleting="GridView1_Changed"
             OnRowDeleted="GridView1_RowDeleted"
            AllowSorting="True" CssClass="table table-bordered table-condensed">
            <Columns>
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:MediaLibraryConnection %>"
            DeleteCommand="sp_DeleteInventory" DeleteCommandType="StoredProcedure" InsertCommand="sp_InsertInventory" InsertCommandType="StoredProcedure" SelectCommand="SELECT Inventory.ItemID, Inventory.ItemName, Inventory.ReleaseDate, Inventory.TypeID, Inventory.GenreID, Inventory.StatusCode, MediaGenre.Description AS Genre, MediaType.Description AS Type, MediaStatus.Description AS Status FROM Inventory INNER JOIN MediaGenre ON Inventory.GenreID = MediaGenre.GenreID INNER JOIN MediaStatus ON Inventory.StatusCode = MediaStatus.StatusCode INNER JOIN MediaType ON Inventory.TypeID = MediaType.TypeID" UpdateCommand="sp_UpdateInventory" UpdateCommandType="StoredProcedure">
            <DeleteParameters>
        ...
        <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:MediaLibraryConnection %>" InsertCommand="sp_InsertInventory" InsertCommandType="StoredProcedure" SelectCommand="SELECT * FROM Inventory">
            <InsertParameters>
                <asp:Parameter Name="ItemName" Type="String" />
                <asp:Parameter DbType="Date" Name="ReleaseDate" />
                <asp:Parameter Name="TypeID" Type="Int32" />
